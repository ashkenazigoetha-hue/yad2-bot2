...
YAD2_MODEL_IDS: dict = {
    ...
    ("ב.מ.וו", "IX3"): 10965, ("ב.מ.וו", "M2"): 10105, ("ב.מ.וו", "M3"): 10106,
    ("ב.מ.וו", "M4"): 10107, ("ב.מ.וו", "X1"): 10111, ("ב.מ.וו", "X2"): 10112,
    ("ב.מ.וו", "X3"): 10113, ("ב.מ.וו", "X4"): 10114, ("ב.מ.וו", "X5"): 10116,
    ("ב.מ.וו", "X6"): 10118, ("ב.מ.וו", "X7"): 10120, ("ב.מ.וו", "Z4"): 10122,
    ("ב.מ.וו", "סדרה 2"): 10096, ("ב.מ.וו", "סדרה 3"): 10097,
    ("ב.מ.וו", "סדרה 5"): 10099, ("ב.מ.וו", "סדרה 7"): 10101,
    ...
    ("טויוטה", "C-HR"): 10225, ("טויוטה", "RAV4"): 10238, ("טויוטה", "אוריס"): 10218,
    ("טויוטה", "יאריס"): 10247, ("טויוטה", "יאריס קרוס"): 11228,
    ("טויוטה", "לנד קרוזר"): 10233, ("טויוטה", "קורולה"): 10226,
    ("יגואר", "E-PACE"): 10248, ("יגואר", "F-PACE"): 10249, ("יגואר", "XE"): 10254,
    ("יגואר", "XF"): 10255,
    ("יונדאי", "I10"): 10272, ("יונדאי", "I20"): 10273, ("יונדאי", "I30"): 10276,
    ("יונדאי", "איוניק 5"): 11239, ("יונדאי", "איוניק 6"): 13099,
    ("יונדאי", "אלנטרה"): 10263, ("יונדאי", "טוסון"): 10291, ("יונדאי", "סונטה"): 10288,
    ...
    ("קיה", "ספורטז'"): 10720, ("קיה", "ספורטאז'"): 10720, ("קיה", "ריו"): 10714,
    ("קיה", "נירו"): 10708, ("קיה", "סורנטו"): 10718, ("קיה", "סלטוס"): 10715,
